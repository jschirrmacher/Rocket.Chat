...
class SideNav extends Page {
	...
	get sidebarUserMenu() {
		return browser.element('.sidebar__header .avatar');
	}
	...
	get spotlightSearchIcon() {
		return browser.element('.sidebar__toolbar-button-icon--magnifier');
	}
	...
	get userAndRoomList() {
		return browser.element('[class="rc-icon sidebar__toolbar-button-icon sidebar__toolbar-button-icon--globe"]');
	}

	get roomFilter() {
		return browser.element('.rc-input__element.rc-directory-selector.js-typeSelector');
	}

	get privateRoomFilter() {
		return browser.element('[value="Private_Groups"]');
	}
