...
const MINOR_ADMIN_ROLE_NAME = 'minor-admin';
...
const createRestrictedAdminRole = function() {
	RocketChat.models.Roles.createOrUpdate(MINOR_ADMIN_ROLE_NAME, 'Users', TAPi18n.__('Minor_admin_description'));
	...
	assignPermissions(MINOR_ADMIN_ROLE_NAME, permissions);
};

Meteor.startup(() => {
	createConfigurationRole();

	createRestrictedAdminRole();
});
